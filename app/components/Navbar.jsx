...
function Navbar() {
  ...
  return (
    ...
    flex items-center justify-between z-50'>
        <a href='#home'>
            <Image src={assets.logo} alt="the logo" className='w-28 cursor-pointer mr-14'/>
        </a>

        <ul className='hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-white-sm shadow-sm bg-opacity-50'>
        ...
        <div className='flex items-center gap-4'>
            ...
            px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contact <Image src={assets.arrow_icon} alt='arrow icon'
            className='w-3'/></a>
